    ...
    public partial class _32 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        tsk_duracao = c.Time(nullable: false, precision: 0),
                        tsk_cor = c.String(nullable: false, maxLength: 20, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        qst_cor = c.String(nullable: false, unicode: false),
                ...
                c => new
                    {
                        ...
                        xpg_data = c.DateTime(nullable: false, precision: 0, defaultValueSql: "CURRENT_TIMESTAMP"),
                    })
                .PrimaryKey(t => new { t.tsk_id, t.gru_id })
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        usu_email = c.String(nullable: false, maxLength: 50, storeType: "nvarchar"),
                ...
                .Index(t => t.usu_email, unique: true, name: "email_unique_idx");
                ...
                c => new
                    {
                        ...
                        tel_tipo = c.String(nullable: false, unicode: false),
                    })
